...
public class NMSShowHiddenPlayerOnTabPacket {

    Class<?> packetPlayOutPlayerInfoClass = NMSUtils.getNMSClass("PacketPlayOutPlayerInfo");

    PacketPlayOutPlayerInfo info;

    public void sendHiddenPlayerOnTab(Player player) {
        try {
