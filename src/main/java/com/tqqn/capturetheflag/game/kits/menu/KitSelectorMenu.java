...
import com.tqqn.capturetheflag.game.kits.types.BuilderKit;
...
public class KitSelectorMenu extends Menu {
    ...
    public KitSelectorMenu() {
        ...
        BuilderKit builderKit = new BuilderKit();
        ...
        registerButton(new MenuButton(builderKit.getIcon()).setWhoClicked(clicked -> {
            Arena.getGamePlayer(clicked.getUniqueId()).setAbstractKit(builderKit);
            clicked.closeInventory();
        }), 1);
