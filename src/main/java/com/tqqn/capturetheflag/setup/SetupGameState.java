...
public class SetupGameState extends AbstractGameState {
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        if (event.getCurrentItem().isSimilar(PluginItems.SETUPWIZARD_SET_LOBBY_LOCATION_ITEM.getItemStack())
            || event.getCurrentItem().isSimilar(PluginItems.SETUPWIZARD_SET_TEAM_BLUE_SPAWN_LOCATION_ITEM.getItemStack())
            || event.getCurrentItem().isSimilar(PluginItems.SETUPWIZARD_SET_TEAM_BLUE_FLAG_LOCATION_ITEM.getItemStack())
            || event.getCurrentItem().isSimilar(PluginItems.SETUPWIZARD_SET_TEAM_RED_SPAWN_LOCATION_ITEM.getItemStack())
            || event.getCurrentItem().isSimilar(PluginItems.SETUPWIZARD_SET_TEAM_RED_FLAG_LOCATION_ITEM.getItemStack())
            || event.getCurrentItem().isSimilar(PluginItems.SETUPWIZARD_SET_POWERUP_LOCATIONS_ITEM.getItemStack())
            || event.getCurrentItem().isSimilar(PluginItems.SETUPWIZARD_SAVE_ITEM.getItemStack())) event.setCancelled(true);
    }

    @EventHandler
    public void onItemDrop(PlayerDropItemEvent event) {
        if (event.getItemDrop().getItemStack().isSimilar(PluginItems.SETUPWIZARD_SET_LOBBY_LOCATION_ITEM.getItemStack())
                || event.getItemDrop().getItemStack().isSimilar(PluginItems.SETUPWIZARD_SET_TEAM_BLUE_SPAWN_LOCATION_ITEM.getItemStack())
                || event.getItemDrop().getItemStack().isSimilar(PluginItems.SETUPWIZARD_SET_TEAM_BLUE_FLAG_LOCATION_ITEM.getItemStack())
                || event.getItemDrop().getItemStack().isSimilar(PluginItems.SETUPWIZARD_SET_TEAM_RED_SPAWN_LOCATION_ITEM.getItemStack())
                || event.getItemDrop().getItemStack().isSimilar(PluginItems.SETUPWIZARD_SET_TEAM_RED_FLAG_LOCATION_ITEM.getItemStack())
                || event.getItemDrop().getItemStack().isSimilar(PluginItems.SETUPWIZARD_SET_POWERUP_LOCATIONS_ITEM.getItemStack())
                || event.getItemDrop().getItemStack().isSimilar(PluginItems.SETUPWIZARD_SAVE_ITEM.getItemStack())) event.setCancelled(true);
    }
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        if (event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (PluginItems.SETUPWIZARD_SET_LOBBY_LOCATION_ITEM.getItemStack().isSimilar(itemStack)) {
            ...
            if (PluginItems.SETUPWIZARD_SET_TEAM_BLUE_SPAWN_LOCATION_ITEM.getItemStack().isSimilar(itemStack)) {
            ...
            if (PluginItems.SETUPWIZARD_SET_TEAM_BLUE_FLAG_LOCATION_ITEM.getItemStack().isSimilar(itemStack)) {
            ...
            if (PluginItems.SETUPWIZARD_SET_TEAM_RED_SPAWN_LOCATION_ITEM.getItemStack().isSimilar(itemStack)) {
            ...
            if (PluginItems.SETUPWIZARD_SET_TEAM_RED_FLAG_LOCATION_ITEM.getItemStack().isSimilar(itemStack)) {
            ...
            if (PluginItems.SETUPWIZARD_SET_POWERUP_LOCATIONS_ITEM.getItemStack().isSimilar(itemStack)) {
            ...
            if (PluginItems.SETUPWIZARD_SAVE_ITEM.getItemStack().isSimilar(itemStack)) {
